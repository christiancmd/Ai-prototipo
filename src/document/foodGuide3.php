...
for ($i = 0; $i < 10; $i++) {
    ...
    $pdf->Cell(70, 10, convert_string('Alimento'), 1, 0, 'C');
...
$pdf->MultiCell(0, 8, convert_string('    Antes de aplicar cualquier diagnóstico, es fundamental leer por completo la información contenida en esta guía alimentaria. Un análisis incompleto puede llevar a interpretaciones erróneas que afecten la salud del paciente.'), 0, 'J');

//Nombre de Archivo
$pdf->Output('I', 'V-' . $id_card_number . '-' . $name . '--' . $date, isUTF8: true); //Ejemplo de Nombre del archivo: 30524903 - 22/05/2025
